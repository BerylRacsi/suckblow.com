    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                    <form method="POST" action="{{url('/post/usertrip')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"  placeholder="Trip Title" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <input class="form-control @error('length') is-invalid @enderror" type="number" name="length" value="{{ old('length') }}" placeholder="1" min="1" max="35000">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" name="itinerary" class="form-control-file @error('itinerary.*') is-invalid @enderror">
                                @error('itinerary.*')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="login_form_inner register_form_inner">
          <h3>Apply as Partner</h3><br>
          <a href="{{url('register')}}">
            or Sign Up as User
          </a><br><br><br>
          <form class="row login_form" method="POST" action="{{ url('register/partner') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-12 form-group">
              <input id="province" type="text" class="form-control @error('province') is-invalid @enderror" name="province" value="{{ old('province') }}" placeholder="Province" required>
              @error('province')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>

    ...
    <div class="row" style="display: flex; flex-wrap: wrap;">
      ...
      <div class="col-lg-6" style="flex-grow: 1;">
        <div class="login_form_inner register_form_inner">
          <h3>Apply as User</h3><br>
          <a href="{{url('register/partner')}}">
            or Sign Up as Partner
          </a><br><br><br>
          <form class="row login_form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-md-12 form-group">
              <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="Phone Number" required>
              @error('phone')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="col-md-12 form-group">
              <select name="nationality" class="form-control" required>
                ...
                <option value="Dast timorese">East Timorese</option>
                ...
                <option value="Trinidadian or tobagonian">Trinidadian or Tobagonian</opton>
